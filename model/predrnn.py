...
# -----------------------------------------------------------------------------
# Paper: Wang, Y., Long, M., Wang, J., Gao, Z., Yu, P. S. (2017)
#        PredRNN: Recurrent Neural Networks for Predictive Learning using Spatiotemporal LSTMs
#        https://proceedings.neurips.cc/paper_files/paper/2017/file/e5f6ad6ce374177eef023bf5d0c018b6-Paper.pdf
# -----------------------------------------------------------------------------
...
class PredRNN_model(nn.Module):
    def __init__(self, num_layers, num_hidden, filter_size, stride, layer_norm, args):
        ...
        for i in range(num_layers):
            ...
            cell_list.append(
                SpatioTemporalLSTMCell(in_channel, num_hidden[i], width, filter_size, stride, layer_norm)
            )
