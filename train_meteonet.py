...
from generator_meteonet import DataGenerator
...
from evaluation.scores_rnn_meteonet import Model_eval_RNN
from evaluation.scores_non_rnn_meteonet import Model_eval_nonRNN


def load_model_config(model_name: str, cfg_root='config/meteonet') -> dict:
...
def DoTrain(args):
    # Data index
    TrainSetFilePath = './data_index/meteonet_train_splitfile.txt'
    TestSetFilePath = './data_index/meteonet_test_splitfile.txt'
    train_list = []
            ...
            for i, X in enumerate(train_loader):
                ...
                # For Non-RNN models
                    ...
                    if args.model == 'm_afno':
                        ...
                        loss = MSE_criterion(pred, ims[:, 5:]) + 0.01 * freq_loss
                    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_length', type=int, default=15, help='')
    parser.add_argument('--total_length', type=int, default=20, help='')
