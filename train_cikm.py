...
from load_earthformer_cikm_cfg import load_earthformer_cikm_config
...
from evaluation.scores_convlstm_modifypatch_retest_targetcopy import Model_eval_RNN
from evaluation.scores_tau_flexible_modifypatch_retest import Model_eval_nonRNN
...
def DoTrain(args):
    ...
    if args.model == 'earthformer':
        model_kwargs = load_earthformer_cikm_config()
    else:
        ...
        with tqdm(total=len(train_loader)) as pbar:
            ...
            for i, X in enumerate(train_loader):
                ...
                # For Non-RNN models
                    ...
                    ims = X.float().to(args.device)
                    if args.model in {'pastnet', 'earthfarseer'}:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_width', type=int, default=104, help='image size')
