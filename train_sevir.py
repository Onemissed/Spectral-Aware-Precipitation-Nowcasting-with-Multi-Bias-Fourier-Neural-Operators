...
from load_earthformer_sevir_cfg import load_earthformer_sevir_config
...
from evaluation.scores_convlstm_sevir_retest_modifygenerator_nodenor import Model_eval_RNN
from evaluation.scores_tau_flexible_sevir_nopatch_retest_modifygenerator_decupk import Model_eval_nonRNN
...
def DoTrain(args):
    ...
    if args.model == 'earthformer':
        model_kwargs = load_earthformer_sevir_config()
    else:
