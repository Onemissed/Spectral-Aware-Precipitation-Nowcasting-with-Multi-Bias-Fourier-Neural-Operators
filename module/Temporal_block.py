...
from module.Fourier_computing_unit import *
import math
...
class TeDev(nn.Module):
    def __init__(self, channel_in, channel_hid, N_T, N_hid, h, w, incep_ker=[3, 5, 7, 11], groups=8):
        ...
        dpr = [x.item() for x in torch.linspace(0, 0, N_hid)]
        self.h = h
        self.w = w
